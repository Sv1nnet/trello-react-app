...
const createBoard = ({ token, title, access, description }) => dispatch => api.board.createBoard(token, { title, access, description })
  .then((res) => {
...
const deleteBoard = (token, boardId) => dispatch => api.board.deleteBoard(token, boardId)
  .then((res) => {
...
const removeBoard = (token, boardId) => (dispatch, getState) => api.board.removeBoard(token, boardId)
  .then((res) => {
...
const loadAllBoards = token => (dispatch, getState) => api.board.loadAllBoards(token)
  .then((res) => {
...
const getBoard = (token, boardId) => dispatch => api.board.getBoard(token, boardId)
  .then((res) => {
...
const updateBoard = (token, boardId, data) => dispatch => api.board.updateBoard(token, boardId, data)
  .then((res) => {
...
const getActivities = (token, boardId, data) => dispatch => api.board.getActivities(token, boardId, data)
  .then((res) => {
...
const updateLabel = (token, boardId, labelId, data) => dispatch => api.board.updateLabel(token, boardId, labelId, data)
  .then((res) => {
